...
def main():
    ...
    inFileName = inDir+"/LUXEDumpFiles_FullSim_0p06BX_DetId33_NoECutNtrn_CoarseBinning_1.005timesNeutron_4.0timesPhoton_v11.root"
    inFile = TFile(inFileName,"READ")



    rUp_theta_neutron = inFile.Get("dump_plane_bkg_track_rUp_track_theta_neutron_cut")
    rDn_theta_neutron = inFile.Get("dump_plane_bkg_track_rDn_track_theta_neutron_cut")
    rUp_theta_photon  = inFile.Get("dump_plane_bkg_track_rUp_track_theta_photon_cut")
    rDn_theta_photon  = inFile.Get("dump_plane_bkg_track_rDn_track_theta_photon_cut")
    ...
    for i in range(0, args.numSmooth):
        clone_rUp_theta_neutron.Smooth() 
        clone_rDn_theta_neutron.Smooth() 
        clone_rUp_theta_photon.Smooth()  
        clone_rDn_theta_photon.Smooth()
