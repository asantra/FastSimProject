...
/// To read a CSV file in C++ without any additional library
...
/// these numbers are needed to normalize the FastSim distribution with the FullSim
...
void makeDumpParticlesFromGANLUXE(string bkgFileName="/Volumes/OS/LUXEBkgOutputFile/Geant4Files/OutputFile/LUXEDumpFiles_FullSim_0p06BX_DetId33_NoECutNtrn.csv", string outDir="/srv01/agrp/arkas/GANFastSim/", int nntrn=5497735, int nphot=1353100, string part="v1"){
    ...
    cout << "Saving n_neutron: " << n_neutron << " and n_photon: " << n_photon << endl;
    ...
    std::string rootoutname2 = outDir+foutname2;
    ...
    for(auto& row: CSVRange(file)){
        ...
        zlocal.push_back(6621.91); // for the z position of the sampling surface
